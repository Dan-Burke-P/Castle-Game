...
public class DeckFunction : MonoBehaviour
{
    ...
    IEnumerator DeckDeal()
    {
        for (int i = 0; i < 5; i++)
        {
            ...
            foreach (string card in bottoms[i])
            {
                ...
                newCard.name = card;
                newCard.GetComponent<DeckSelectable>().row = i;
                if (card == bottoms[i][bottoms[i].Count -1])
                {
                    newCard.GetComponent<DeckSelectable>().faceUp = true;
                }
    ...
    public void DealFromDeck()
    {
        ...
        if (deckLocation < trips)
        {
            ...
            foreach (string card in deckTrips[deckLocation])
            {
                ...
                newTopCard.GetComponent<DeckSelectable>().faceUp = true;
                newTopCard.GetComponent<DeckSelectable>().inDeckPile = true;
            }
            deckLocation++;
